    ...
    <div class="container mt-5">
        <ul class="nav nav-tabs">
            <li class="nav-item non-active">
                <a class="nav-link" aria-current="page" href="{{ route('employee_list') }}">Employee List</a>
            </li>
            <li class="nav-item active-nav mx-1">
                <a class="nav-link active" href="{{ route('add_new_employee') }}">Add New</a>
            </li>
        </ul>
